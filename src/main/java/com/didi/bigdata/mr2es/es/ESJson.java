...
//                }
                ...
                if (value != null && !value.toString().trim().equals("")) {
                    ...
                    if (mysqlType.equalsIgnoreCase("bigint")) {
                        ...
                        if (!fieldName.equals("home_lnglat") &&
                                !fieldName.equals("company_lnglat")
                                && !fieldName.equals("hotspot_lnglat")) {
